...
const Nav = () => {
  return (
    <div className="nav w-full h-25 flex items-center justify-between p-6 ">
        <div className='text-4xl shadow-2xl h-[60px] w-[60px] bg-white flex items-center justify-center rounded'>
           ...
           <form className='flex items-center  gap-10 w-[60%] h-[55px] px-5 bg-white rounded shadow-2xl'>
             <IoIosSearch className='text-green-500 h-7.5 w-7.5' />
            <input 
            className='border h-full w-full outline-none text-2xl border-none'
